    ...
    <div className="min-h-screen bg-gray-50 py-8">
      ...
      <div className="container mx-auto px-4 mb-6">
        <nav className="flex items-center text-sm text-gray-600">
          ...
          <span className="text-green-600 font-medium">Class 7</span>
        </nav>
      </div>
      ...
      <div className="container mx-auto px-4 mb-8">
        <div className="bg-gradient-to-r from-green-600 to-green-700 rounded-2xl p-8 text-white shadow-lg">
          <h1 className="text-4xl font-bold mb-2">Class 7</h1>
          <p className="text-green-100 text-lg">সপ্তম শ্রেণি - সকল বিষয়সমূহ</p>
        </div>
      </div>
